...
# Força a leitura do .env no mesmo diretório do projeto
...
class NotificadorEmail:
    ...
    def disparar(self, remetente: str, destinatarios, assunto: str, corpo: str,
                 anexo=None, nome_anexo: str=None) -> bool:
        """
        Monta e envia o e-mail com ou sem anexo via SMTP (Brevo).
        ...
        # Só adiciona anexo se ele for fornecido
        if anexo and nome_anexo:
